...
import 'package:front/app/di/project_di.dart';
...
final getTeamMembersByTeamIdUseCase = locator<GetTeamMembersByTeamIdUseCase>();
...
final projectRemoteDataSource = locator<ProjectRemoteDataSource>();
final projectRepository = locator<ProjectRepository>();

final createProjectUseCase = locator<CreateProjectUseCase>();
final getProjectsByTeamIdUseCase = locator<GetProjectsByTeamIdUseCase>();
final getProjectByIdUseCase = locator<GetProjectByIdUseCase>();
...
void initLocator() {
  ...
  ProjectDependencyInjection().init();
}

import 'package:front/core/task/data/models/task.dart';
import 'package:front/core/task/domain/entities/task.dart';
import 'package:front/core/task/domain/entities/tasks.dart';
...
class TasksModel {
  ...
  TasksEntity toEntity() => TasksEntity(values: values.map((taskModel) => taskModel.toEntity()).toList());
}
